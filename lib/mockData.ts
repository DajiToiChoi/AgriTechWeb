...
export const MOCK_ALERTS = [
  ...
  { id: 3, type: "info", message: "Đã bật bơm tưới khu rau xanh Farm Anh Đạt", time: "2 giờ trước", resolved: true },
];

export const MOCK_PRODUCTION_LOGS = [
  { id: 1, action: "Thu hoạch rau cải đợt 1", user: "Admin", date: "2026-04-24", batch: "AD-RAUCAI-001" },
  { id: 2, action: "Kiểm tra luống đậu que", user: "Kỹ sư Hùng", date: "2026-04-20", batch: "AD-DAUQUE-001" },
  { id: 3, action: "Kiểm tra mùng tơi định kỳ - Tốt", user: "Kỹ sư Hùng", date: "2026-04-18", batch: "AD-MUNGTOI-001" },
  { id: 4, action: "Gieo hạt rau cải mẻ mới", user: "Admin", date: "2026-04-15", batch: "AD-RAUCAI-002" },
];
...
export const MOCK_BATCH_INFO = {
  ...
  certifications: ["Đối tác farm"],
  manager: "Farm Anh Đạt",
};
...
export const MOCK_AI_MARKETING = [
  ...
  },
  {
    ...
    content:
      "Combo rau xanh Farm Anh Đạt gồm rau mùng tơi, rau cải và đậu que. Các sản phẩm phù hợp cho những món ăn gia đình đơn giản như canh, luộc, xào tỏi hoặc xào cùng thịt/nấm. Nên bảo quản trong ngăn mát 2-4°C và dùng sớm để giữ độ tươi.",
  },
];
