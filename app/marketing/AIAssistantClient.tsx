...
import { Bot, Leaf, Loader2, Send, Sparkles, Utensils, Wand2 } from "lucide-react";
...
const capabilities = [
  { icon: Utensils, title: "Gợi ý combo", text: "Kết hợp mùng tơi, rau cải, đậu que thành set dễ mua, dễ nấu." },
...
const initialMessages: ChatMessage[] = [
  {
    role: "assistant",
    content:
      "Xin chào, tôi là VieGarden AI. Bạn có thể hỏi về combo rau mùng tơi, rau cải, đậu que, cách chế biến, bảo quản hoặc thành phần cơ bản như vitamin/chất xơ.",
  },
];
    ...
    <main className="min-h-screen bg-background pb-16">
      <section className="container-page pt-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-3xl font-extrabold leading-tight tracking-tight text-primary sm:text-4xl md:text-5xl md:leading-tight">
            Trợ lý AI gợi ý combo và cách chế biến nông sản
          </h1>
          <p className="mt-5 text-lg leading-8 text-muted-foreground">
            AI hỗ trợ gợi ý combo rau mùng tơi, rau cải, đậu que, cách chế biến, bảo quản và thành phần cơ bản.
          </p>
        </div>
      </section>
      ...
      <section className="container-page mt-12 grid gap-8 lg:grid-cols-12">
        <aside className="space-y-6 lg:col-span-3">
          <div className="rounded-3xl border bg-card p-6 shadow-sm">
            <h2 className="mb-5 text-xl font-extrabold text-primary">Khả năng</h2>
          ...
          <div className="relative aspect-square overflow-hidden rounded-3xl">
            ...
            <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/65 to-transparent p-6 text-white">
              ...
              <p className="text-sm text-white/80">Gợi ý combo và món ăn từ rau củ tại farm.</p>
            </div>
          </div>
        </aside>
